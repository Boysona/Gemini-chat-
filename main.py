...
# ====== CONFIGURATION ======
# Halkan ku qoro token-kaaga Telegram bot (maya getenv)
BOT_TOKEN  = "7236852370:AAF7I0G4t6iQWX5vmkh2b8EnTCVgxuQZzPo"  # <-- bedel halkan
# Halkan ku qor URL-ka app-kaaga Render (maya getenv)
...
if __name__ == "__main__":
    # Haddii hore uu jiro AUDIO_DIR, nadiifi
    if os.path.exists(AUDIO_DIR):
        shutil.rmtree(AUDIO_DIR)
    os.makedirs(AUDIO_DIR, exist_ok=True)

    # Set webhook mar kowaad
